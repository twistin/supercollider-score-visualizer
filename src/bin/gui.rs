// Binario experimental para la interfaz gráfica (GUI) de SC Score Visualizer.
// Actualmente deshabilitado temporalmente porque el módulo `gui` no compila correctamente.
// Para activarlo, descomenta el bloque principal e implementa `sc_score_visualizer::gui::run_gui()`.
